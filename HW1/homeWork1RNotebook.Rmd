...
```
## Problem 1C
```{r 1C Create a scatter plot using ggplot of salary vs pubs, echo=FALSE}
...
```
##Problem 1D
```{r 1D now add a factor to the previous plot, echo=FALSE}
...
```{r create a pdf with a mean of 25 and sd of 5, echo=FALSE}
...
```{r 2B find percent of distribution greater than 24 & less than 28 exclusive, echo=FALSE}
## First plot what we want
mean=25; sd=5
lb=24 ; ub=28
x <- x.seq
...
## Problem 2C
```{r 2C calculate the z score of the 50th percentile, echo=FALSE}
## First plot what we want
mean=25; sd=5
x <- x.seq
hx <- dnorm(x,mean,sd)
...
## Problem 2D
```{r 2D the z scores of the values grabbing 50percent of the data, echo=FALSE}
## First plot what we want
mean=25; sd=5
x <- x.seq
hx <- dnorm(x,mean,sd)
...
## Problem 2E
```{r 2E the z scores of the values grabbing 95percent of the data, echo=FALSE}
## First plot what we want
mean=25; sd=5
x <- x.seq
hx <- dnorm(x,mean,sd)
